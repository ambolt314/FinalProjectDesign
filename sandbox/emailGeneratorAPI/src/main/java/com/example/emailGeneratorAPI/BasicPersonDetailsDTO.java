...
public class BasicPersonDetailsDTO {
    ...
    private String firstNameKnownAs;
    ...
    public String getFirstNameKnownAs() {
        return firstNameKnownAs;
    }

    public void setFirstNameKnownAs(String firstNameKnownAs) {
        this.firstNameKnownAs = firstNameKnownAs;
    }
